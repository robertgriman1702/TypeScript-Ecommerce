              ...
              <div className="relative flex justify-end">
                {user ? (
                  <div className="relative">
                    ...
                    {showUserMenu && (
                      <div className="absolute right-0 top-10 md:top-11 bg-white text-gray-800 rounded-xl shadow-xl border border-gray-100 w-44 md:w-48 z-50 overflow-hidden">
              ...
              <div className="flex flex-row-reverse items-center gap-2 md:gap-4">
                <div className="flex items-center gap-2">
                  <Link to="/cart" className="relative">
                    ...
                    <HiOutlineShoppingCart size={32} strokeWidth={1} className="md:hidden bg-amber-50 text-blue-950 hover:text-amber-400 transition-colors" />
