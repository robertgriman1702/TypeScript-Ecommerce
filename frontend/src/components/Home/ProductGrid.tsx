      ...
      <div className="max-w-7xl mx-auto px-3 md:px-5 lg:px-12">
        ...
        {title && (
          <div className="text-center mb-6 md:mb-10">
            <span className="inline-flex items-center gap-1 bg-amber-400 text-white text-xs font-semibold px-3 py-1 rounded-full mb-3">
            ...
            <p className="text-gray-500 mt-2 text-sm max-w-xl mx-auto hidden md:block">
        ...
        {showTabs && onTabChange && (
          <div className="flex justify-start md:justify-center mb-6 md:mb-10 overflow-x-auto pb-1">
            <div className="flex bg-white border-2 border-gray-200 rounded-xl p-1 shadow-lg gap-1 flex-shrink-0">
              {tabs.map(t => (
                <button
                  key={t.key}
                  ...
                  className={`flex items-center gap-1 md:gap-2 px-3 md:px-5 py-2 md:py-2.5 rounded-lg text-xs md:text-sm font-semibold transition-all duration-200 whitespace-nowrap
                    ${activeTab === t.key ? 'bg-slate-800 text-white shadow' : 'text-gray-500 hover:text-gray-800'}`}
                >
